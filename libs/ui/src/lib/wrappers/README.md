...
- `tree-wrapper`: [`tree-wrapper/README.md`](tree-wrapper/README.md)

## Regla

Si cambia API o comportamiento de un wrapper, actualizar su `README.md` en la misma PR.
